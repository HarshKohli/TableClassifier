...
for epoch_num in range(config['num_epochs']):
    for train_question, train_header, train_table_word in zip(train_questions, train_headers, train_table_words):
        loss = train_step(train_question, train_header, train_table_word,
                          [[0.0, 1.0] for _ in range(len(train_question))])
