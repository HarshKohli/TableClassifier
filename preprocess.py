...
dev_data, dev_tables = process_test_data(config['dev_data'], config['dev_tables'], config['real_proxy_token'])
test_data, test_tables = process_test_data(config['test_data'], config['test_tables'], config['real_proxy_token'])
